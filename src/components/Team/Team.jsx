        ...
        <div className="flex" >
            ...
            <div className="flex flex-wrap justify-center md:justify-normal">
                <div className="flex flex-col items-center h-[7.5rem] w-[7.5rem] mt-10 sm:mt-20 mx-4 sm:mx-4 md:mx-10 ">
                    <img src="src/assets/avinash.jpg" className="rounded-lg "></img>
                ...
                <div className="flex flex-col items-center h-[7.5rem] w-[7.5rem] mt-10 sm:mt-20 mx-4 sm:mx-4 md:mx-10  ">
                    <img src="src/assets/aditya.jpg" className="rounded-lg "></img>
